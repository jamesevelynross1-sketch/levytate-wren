...
export const portakabinPathwayStandards: ApprenticeshipPathway[] = [
  ...
  { id: "path-l3-construction-site-supervisor", title: "Level 3 Construction Site Supervisor", standard: "Construction Site Supervisor", level: "L3", family: "Installation & Site Operations", summary: "Develops site coordination, handover discipline, quality checks and field leadership.", typicalDuration: "18 to 24 months" },
...
export const portakabinRoleLibrary: RoleLibraryRole[] = [
  role({
    ...
    careerLevel: "Entry",
    typicalProgression: ["Senior Operator", "Team Leader", "Production Supervisor"],
  ...
  role({
    ...
    typicalProgression: ["Production Manager", "Operations Manager"],
  ...
  role({
    ...
    siteApplicability: ["York Head Office, Visitor Centre and UK Factory"],
    careerLevel: "Manager",
    typicalProgression: ["Engineering Manager", "Operations Manager"],
    futureProgressionRoleIds: ["role-002"],
  ...
  role({
    ...
    siteApplicability: ["All sites"],
    careerLevel: "Entry",
    typicalProgression: ["Customer Service Specialist", "Customer Service Team Leader"],
  ...
  role({
    ...
    siteApplicability: ["All sites"],
    careerLevel: "Supervisor",
    typicalProgression: ["Customer Operations Manager", "Regional Hire Manager"],
  ...
  role({
    ...
    siteApplicability: ["All sites"],
    careerLevel: "Supervisor",
    typicalProgression: ["Site Manager", "Operations Manager"],
...
export const roleCapabilityTags: RoleCapabilityTag[] = ["Leadership", "Technical", "Digital", "AI", "Compliance", "People management", "Customer facing", "Operational", "Commercial", "Procurement"];
