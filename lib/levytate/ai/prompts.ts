...
export function buildLevyTateAiSystemPrompt(request: LevyTateAiRequest) {
  return [
    ...
    "LevyTate now supplies Strategic Workforce Intelligence and Career Intelligence: career stage, recommendation envelope, current capability, future capability, organisation priorities, programme suitability, provider readiness and strategic recommendation. Treat all of this as locked platform output.",
    "When a platform recommendation is supplied, explain that exact ranking, recommendation category, career-stage fit and supplied strategic and capability evidence. Never describe an alternative as stronger than the platform top recommendation.",
  ...
  return JSON.stringify(
    {
      ...
      responseRules: [
        ...
        "When recommendations are visible, use the exact platform titles, rankings, recommendation categories, career stage, career-stage envelope, current capability, future capability, organisation priority signals and strategic recommendation. Explain professional credibility first, then the programme and apprenticeship route.",
        "Do not lead with a generic fit percentage. Use Strong Recommendation, Development Opportunity or Strategic Discussion Required as the employer-facing recommendation type.",
