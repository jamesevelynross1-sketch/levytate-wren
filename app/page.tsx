...
const pathways: Pathway[] = [
  {
    ...
    commitment: "Blended learning with live procurement and framework evidence.",
    cohort: "September procurement cohort",
  },
  {
  ...
  },
  {
    ...
    commitment: "Hybrid learning with delivery governance and workstream evidence.",
    cohort: "October project delivery group",
  },
  {
    title: "Data & Digital",
    ...
    duration: "18 to 24 months",
    commitment: "Remote learning, workshops and applied reporting projects.",
    cohort: "November data and digital cohort",
  },
  {
    ...
    duration: "18 to 24 months",
    commitment: "Online learning, coaching and applied impact reporting evidence.",
    cohort: "September social value cohort",
  },
  {
    ...
    cohort: "Rolling business support starts",
  },
  {
    ...
    deliveryPartner: "Approved Provider D",
    duration: "18 to 24 months",
    commitment: "Remote learning, workshops and applied platform support evidence.",
    cohort: "December technology start",
  },
  {
    ...
    commitment: "Blended learning with service improvement and delivery evidence.",
    cohort: "January operations cohort",
  },
];

const initialRequests: RequestItem[] = [
  { id: 1, name: "Amelia Hart", role: "Framework Coordinator", department: "Pagabo", team: "Framework Delivery", pathway: "Procurement & Commercial", manager: "Ryan Booth", status: "Manager review", note: "Framework confidence." },
  { id: 2, name: "Marcus Lee", role: "Product Support Lead", department: "Sypro", team: "Platform Support", pathway: "Data & Digital", manager: "Priya Nair", status: "Manager review", note: "Reporting capability." },
  { id: 3, name: "Sophie Clarke", role: "Social Value Coordinator", department: "Loop", team: "Impact Reporting", pathway: "Social Value & Sustainability", manager: "Helen Ward", status: "Lead review", note: "Impact reporting." },
  { id: 4, name: "Noah Bennett", role: "Operations Manager", department: "Group Operations", team: "Operating Rhythm", pathway: "Leadership & Management", manager: "Sam Ellis", status: "New interest", note: "Collaborative growth." },
  { id: 5, name: "Grace Patel", role: "Project Coordinator", department: "Delivery", team: "Client Programmes", pathway: "Project Management", manager: "Ryan Booth", status: "Provider introduction", note: "Client programme support." },
  { id: 6, name: "Leo Morgan", role: "Systems Analyst", department: "Technology", team: "Internal Systems", pathway: "Technology & Systems", manager: "Helen Ward", status: "Manager review", note: "Platform support." },
  { id: 7, name: "Maya Singh", role: "Delivery Lead", department: "Group Operations", team: "Delivery Excellence", pathway: "Operations & Delivery", manager: "Priya Nair", status: "Enrolment", note: "Operational excellence." },
  { id: 8, name: "Ethan Brooks", role: "Business Support Officer", department: "Group Services", team: "Business Support", pathway: "Business Administration", manager: "Sam Ellis", status: "Live learner", note: "Process improvement." },
];

const initialMappings: ProviderMapping[] = [
  { roleFamily: "Procurement & Commercial", pathway: "Procurement & Commercial", standard: "L4 Commercial Procurement & Supply", partner: "Approved Provider A", deliveryModel: "Blended", fit: 94, status: "Live", nextAction: "Prepare next cohort" },
  { roleFamily: "Leadership & Management", pathway: "Leadership & Management", standard: "L3 Team Leader / L5 Operations Manager", partner: "Approved Provider B", deliveryModel: "Online + workshops", fit: 92, status: "Live", nextAction: "Review next cohort" },
  { roleFamily: "Project Management", pathway: "Project Management", standard: "L4 Associate Project Manager", partner: "Approved Provider C", deliveryModel: "Hybrid", fit: 90, status: "Live", nextAction: "Confirm delivery timetable" },
  { roleFamily: "Data & Digital", pathway: "Data & Digital", standard: "L4 Data Analyst / Digital pathways", partner: "Approved Provider D", deliveryModel: "Remote + workshops", fit: 89, status: "Ready", nextAction: "Mark as live" },
  { roleFamily: "Social Value & Sustainability", pathway: "Social Value & Sustainability", standard: "ESG aligned pathway", partner: "Approved Provider E", deliveryModel: "Online + coaching", fit: 88, status: "Ready", nextAction: "Validate Loop demand" },
  { roleFamily: "Operations & Delivery", pathway: "Operations & Delivery", standard: "L3 Improvement Technician", partner: "Approved Provider F", deliveryModel: "Blended", fit: 87, status: "Ready", nextAction: "Flag for delivery review" },
];
...
const scenarioSeeds: Record<DemandScenario, RequestItem[]> = {
  ...
  High: [
    ...initialRequests,
    { id: 9, name: "Olivia Grant", role: "Commercial Lead", department: "Pagabo", team: "Supplier Engagement", pathway: "Procurement & Commercial", manager: "Ryan Booth", status: "New interest", note: "Commercial capability." },
    { id: 10, name: "Daniel Fox", role: "Implementation Coordinator", department: "Delivery", team: "Client Programmes", pathway: "Project Management", manager: "Sam Ellis", status: "Manager review", note: "Delivery control." },
    { id: 11, name: "Isla Reid", role: "Insight Analyst", department: "Sypro", team: "Platform Data", pathway: "Data & Digital", manager: "Priya Nair", status: "Lead review", note: "Product insight." },
  ],
};
...
export default function Home() {
  ...
  const [savedPathways, setSavedPathways] = useState<string[]>(["Procurement & Commercial", "Social Value & Sustainability"]);
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const nextRequest: RequestItem = {
      ...
      department: String(data.get("department") || "Pagabo"),
    ...
    setRequests((current) => [
      {
        ...
        department: seed.title.includes("Data") ? "Sypro" : "Pagabo",
      ...
      <section className="mx-auto max-w-7xl px-5 pb-8 pt-12 lg:px-8 lg:pb-12 lg:pt-16">
        <div className="grid gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:items-end">
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.02] text-[#102c3d] md:text-7xl">PAGABO Apprenticeship Hub</h1>
        ...
        <div className="grid gap-5 lg:grid-cols-[1fr_0.9fr]">
          <div>
            <p className="max-w-2xl text-base leading-7 text-[#102c3d]/64">
              Explore approved development pathways across PAGABO Group, understand what fits your role or team, and start a request in minutes.
            </p>
  ...
  return (
    <div className="grid gap-6">
      ...
      <PanelShell title="Team development pipeline" eyebrow="Manager View">
        <Kanban requests={requests.filter((request) => ["Pagabo", "Sypro", "Loop"].includes(request.department))} compact />
      </PanelShell>
    </div>
  );
}
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_0.9fr]">
        ...
        <PanelShell title="Operational skills snapshot" eyebrow="Priority Areas">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <MiniMetric label="Recommended cohorts" value="3" copy="Procurement, social value, leadership" />
  ...
  return (
    <div className="grid gap-6">
      <PanelShell title="Advanced operating snapshot" eyebrow="Apprenticeship Lead Console">
        <p className="max-w-2xl text-base leading-7 text-[#102c3d]/64">
          LevyTate gives PAGABO apprenticeship leads one place to manage demand, approvals, provider mappings and internal rollout.
        </p>
...
function RequestForm({ onSubmit }: { onSubmit: (event: FormEvent<HTMLFormElement>) => void }) {
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      ...
      <Field name="role" label="Role" defaultValue="Framework Coordinator" />
      <Field name="department" label="Department" defaultValue="Pagabo" />
      <Field name="team" label="Team" defaultValue="Framework Delivery" />
      ...
      <label className="grid gap-2 text-sm font-medium text-[#102c3d]/70">
        Why is this needed?
        <textarea name="need" rows={4} className="rounded-2xl border border-[#102c3d]/10 bg-[#f8fbfa] px-4 py-3 outline-none focus:border-[#159b8f]" defaultValue="I want to build stronger commercial and framework delivery confidence." />
      </label>
