...
check("canonical employer navigation label", shell.includes('module !== "Knowledge"') && shell.includes('"Guidance Centre"'));
...
check("Platform Admin navigation is explicitly administrative", shell.includes('"Guidance administration"'));
