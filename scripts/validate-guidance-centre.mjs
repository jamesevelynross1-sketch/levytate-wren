...
check("canonical employer navigation label", policy.includes('item("Knowledge", "Guidance Centre", "secondary", "support", "supporting")'));
...
check("Platform Admin navigation is explicitly administrative", policy.includes('item("Knowledge", "Guidance Administration", "secondary", "support", "supporting")'));
